...
from app.schemas.ticket import TicketCreate, TicketUpdate, TicketStatusCreate
...
class TestTicketService:
    ...
    def test_create_ticket_success(self, ticket_service, setup_basic_data):
        ...
        from app.crud import ticket as ticket_crud
        from app.models import Person, Flight, SeatClass, TicketStatus
    ...
    def test_update_ticket(self, ticket_service, setup_basic_data):
        """Обновление билета."""
        from app.models import Person, Flight, SeatClass
    ...
    def test_search_tickets(self, ticket_service, setup_basic_data):
        """Поиск билетов."""
        from app.models import Person, Flight, SeatClass
        from app.schemas.ticket import TicketSearch

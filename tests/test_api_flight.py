...
class TestAirportAPI:
    ...
    def test_delete_airport(self, client, test_airport_data):
...
class TestAirlineAPI:
    ...
    def test_get_all_airlines(self, client, test_airline_data):
        """Получение всех авиакомпаний через API."""
        client.post("/api/v1/flights/airlines/", json=test_airline_data)
...
class TestFlightStatusAPI:
    ...
    def test_get_all_flight_statuses(self, client, test_flight_status_data):
...
class TestFlightAPI:
    ...
    def test_create_flight_past_datetime(self, client, setup_flight_data):
    ...
    def test_search_flights(self, client, setup_flight_data):
    ...
    def test_delete_flight(self, client, setup_flight_data):
